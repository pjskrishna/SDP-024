...
//     const name = ‘Krishna ';
//     message += name; // 'Hello my name is Krishna'

//     final message = StringBuffer();
//     message.write('Hello');
//     message.write(' my name is ');
//     message.write('Krishna');
//     message.toString(); // "Hello my name is Krishna"
//     //toString to convert the string bufferto the String type. 
//     //Interpolation

//     const name = "Krishna ";
//     const intro = "Hello , My name is $name"; //Hello my name is Krishna
...
//       const lastname = " Chapla";

//       //2.
//       const fullname = firstname + lastname;

//       //3.
//       const mydetail = " Hello , My name is $fullname";//Hello , My name is Krishna Chapla
